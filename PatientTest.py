# Program to check if a patient's test result is normal or abnormal
# Dictionary to hold test names and their normal ranges
test_result_value = (("RBC", (4.32, 5.72)), ("WBC", (3.5, 10.5)), ("HEMOGLOBIN", (13, 17)), ("PLATELET", (1.5, 4.0)), ("MCV", (90.4, 128)))
dict = {}

# Populate the dictionary with test names and their normal ranges
...
# Check if the test name exists and validate the result
